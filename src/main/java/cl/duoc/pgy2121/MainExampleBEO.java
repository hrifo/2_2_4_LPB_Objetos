...
public class MainExampleBEO {
    ...
    public static void main(String[] args) {
        ...
        Trabajador empleado1 = new Trabajador("Juan Perez", "12189443", "5"); 
        Trabajador gift1 = new Trabajador("6018741302285000","1219",35000,"30 de octubre 2020","Juan Perez");
        ...
        System.out.println("Ingrese rut del dueño de la giftcard");
